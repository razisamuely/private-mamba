...
def render_trained_policy(model_path=None, map_name="2s_vs_1sc", save_gif=True, gif_filename="starcraft_policy.gif", fps=10):
    env_config = StarCraftConfig(map_name)
